...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { HCLK }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -add -name sys_clk_pin -period 50.00 -waveform {0 25} [get_ports { HCLK }];
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { HRESETn }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
