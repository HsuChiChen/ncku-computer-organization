...
create_clock -period 10 -name sys_clk_pin -waveform {0 5} -add [get_ports {HCLK}]


##Switches

set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { uart_rst }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { LIGHT }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { LIGHT1 }]; #IO_L24P_T3_RS1_15 Sch=led[1]
#set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { LED2 }]; #IO_L17N_T2_A25_15 Sch=led[2]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { alarm }]; #IO_L8P_T1_D11_14 Sch=led[3]
...
set_property PACKAGE_PIN U16 [get_ports LED_7]
...
set_property PACKAGE_PIN C12 [get_ports HRESETn]
...
#set_property -dict { PACKAGE_PIN E5    IOSTANDARD LVCMOS33 } [get_ports { alarm }]; #IO_L5N_T0_AD13N_35 Sch=uart_rts
